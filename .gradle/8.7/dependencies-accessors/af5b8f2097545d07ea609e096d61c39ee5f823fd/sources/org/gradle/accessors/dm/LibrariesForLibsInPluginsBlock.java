...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class Material3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Group of libraries at <b>material3.window</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class Material3WindowLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getSize() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("material3.window.size");
        }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>okhttp.logging</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>play.auth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>33.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycle.runtime.ktx</b> with value <b>2.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OkhttpVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>okhttp.logging</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PlayVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.auth</b> with value <b>21.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAuth() { return getVersion("play.auth"); }

        /**
         * Version alias <b>play.identity</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIdentity() { return getVersion("play.identity"); }
