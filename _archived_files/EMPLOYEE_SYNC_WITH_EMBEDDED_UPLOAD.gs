/********************************************************************
 * 🔰 EMPLOYEE SYNC ENGINE — WITH EMBEDDED IMAGE UPLOAD
 * ---------------------------------------------------------------
 * This version has image upload logic embedded directly to ensure it works
 * You can separate it later once everything is working
 ********************************************************************/
...
/* ================================================================
   IMAGE UPLOAD (EMBEDDED - ENSURES IT WORKS)
================================================================ */
...
function handleBlobSave(e, blob, kgid, debug) {
  try {
    ...
    if (kgid) {
      try {
        updateFirebaseProfileImage(kgid, url);
      } catch (_) {}
    }
...
/* ================================================================
   API (WITH EMBEDDED IMAGE UPLOAD)
================================================================ */
...
function doPost(e) {
  try {
    ...
    // ✅ Route image upload (function is in same file)
